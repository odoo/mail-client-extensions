...
def migrate(cr, version):
    ...
    for field_name in ('journal_currency_id', 'move_name', 'journal_entry_ids', 'note', 'account_id', 'bank_account_id'):
    ...
    for field_name in ('company_id', 'journal_id', 'name', 'state'):
    ...
    for field_name in ('move_name', 'payment_date', 'communication', 'payment_difference', 'payment_difference_handling',
                       'writeoff_account_id', 'writeoff_label', 'possible_bank_partner_ids', 'partner_bank_account_id',
                       'state_before_switch', '_suitable_journal_ids', '_payment_methods', 'move_reconciled',
                       'move_line_ids', 'has_invoices', 'invoice_ids', 'destination_journal_id'):
    ...
    for partner_type, property_name in [('customer', 'property_account_receivable_id'), ('supplier', 'property_account_payable_id')]:
        cr.execute('''

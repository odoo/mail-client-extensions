...
def migrate(cr, version):
    util.remove_field(cr, "helpdesk.team", "display_timesheet_timer")
    util.remove_field(cr, "helpdesk.team", "timesheet_timer")
    util.remove_field(cr, "helpdesk.ticket", "timesheet_timer")

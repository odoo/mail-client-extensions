...
def migrate(cr, version):
    util.remove_view(cr, "l10n_lu_reports.view_company_form")
    util.remove_view(cr, "l10n_lu_reports.view_l10n_lu_generate_xml")
    util.remove_record(cr, "l10n_lu_reports.action_l10n_lu_generate_xml")
    util.remove_field(cr, "l10n_lu.generate.xml", "by_fidu")

    if util.column_exists(cr, "l10n_lu_reports", "l10n_lu_agent_ecdf_prefix"):

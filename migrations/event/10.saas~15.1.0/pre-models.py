...
def migrate(cr, version):
    ...
    get_default = env['ir.values'].get_default if 'ir.values' in env else env['ir.default'].get
    auto_confirm = bool(get_default('event.config.settings', 'auto_confirmation')) or False

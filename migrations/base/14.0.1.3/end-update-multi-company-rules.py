...
def update_rules(cr, rules):
    installed = set()
    for xmlid in rules:
        module, _, _ = xmlid.partition(".")
        if module in installed or util.module_installed(cr, module):
            installed.add(module)
            util.update_record_from_xml(cr, xmlid, reset_write_metadata=False)
...
lunch.ir_rule_lunch_product_report_multi_company
...
hr_appraisal.hr_appraisal_plan_comp_rule
...
l10n_be_hr_payroll.ir_rule_attachment_salary_report_multi_company

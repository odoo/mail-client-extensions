...
def migrate(cr, version):
    ...
    util.module_deps_diff(cr, 'hr_timesheet_attendance',
                          plus={'hr_timesheet'}, minus={'hr_timesheet_sheet'})
    ...
    util.module_deps_diff(cr, 'website_sale',
                          plus={'website_account', 'website_rating', 'sale_payment'},
                          minus={'rating', 'sale', 'payment'})
    util.module_deps_diff(cr, 'website_sale_digital',
                          plus={'website_portal_sale'}, minus={'website_sale'})

    util.new_module(cr, 'website_sale_management', deps={'sale_management', 'website_sale'},
                    auto_install=True)
    ...
    if util.has_enterprise():
        ...
        util.new_module(cr, 'website_delivery_ups', deps={'delivery_ups', 'website_sale_delivery'},
                        auto_install=True)
        util.new_module(cr, 'website_quote_subscription', deps={'sale_subscription', 'website_quote'},
                        auto_install=True)
        ...
        util.module_deps_diff(cr, 'project_timesheet_synchro',
                              plus={'hr_timesheet'}, minus={'hr_timesheet_sheet'})
        util.module_deps_diff(cr, 'sale_subscription_asset',
                              plus={'account_deferred_revenue'}, minus={'account_asset'})
        util.new_module_dep(cr, 'website_form_editor', 'website_enterprise')
        util.module_deps_diff(cr, 'website_subscription',

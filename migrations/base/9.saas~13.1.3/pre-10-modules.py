...
def migrate(cr, version):
    if util.has_enterprise():
        ...
        util.new_module(cr, 'website_helpdesk_forum',
                        deps=('website_forum', 'website_helpdesk'), auto_install=True)
        util.new_module(cr, 'website_helpdesk_livechat',
                        deps=('helpdesk', 'website_livechat'), auto_install=True)
        util.new_module(cr, 'website_helpdesk_slides',
                        deps=('website_helpdesk', 'website_slides'), auto_install=True)
    ...
    util.new_module(cr, 'hr_recruitment_survey',
                    deps=('hr_recruitment', 'survey'),
                    auto_install=True)

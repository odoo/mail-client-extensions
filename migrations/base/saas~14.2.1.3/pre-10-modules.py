...
def migrate(cr, version):
    ...
    util.merge_module(cr, "sale_timesheet_edit", "sale_timesheet", update_dependers=False)
    ...
    if util.has_enterprise():
        util.merge_module(cr, "helpdesk_sale_timesheet_edit", "helpdesk_sale_timesheet", update_dependers=False)
        util.merge_module(cr, "website_crm_score", "crm", update_dependers=False)
        ...
        util.new_module(cr, "l10n_be_hr_payroll_holiday_pay_recovery", deps={"l10n_be_hr_payroll"}, auto_install=True)

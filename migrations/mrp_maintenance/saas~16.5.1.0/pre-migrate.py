...
def migrate(cr, version):
    ...
    util.create_column(cr, "maintenance_request", "workcenter_id", "int4")
    query = """
    ...
    util.create_column(cr, "mrp_workcenter", "maintenance_team_id", "int4")
    util.create_column(cr, "mrp_workcenter", "technician_user_id", "int4")

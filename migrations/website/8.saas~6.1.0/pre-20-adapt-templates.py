...
def migrate(cr, version):
    ...
    with util.skippable_cm(), util.edit_view(cr, 'website.footer_custom', skip_if_not_noupdate=False) as arch:
    ...
    with util.skippable_cm(), util.edit_view(cr, 'website.footer_default', skip_if_not_noupdate=False) as arch:
        node = arch.find('.//div')
        node.attrib['id'] = "footer"

    with util.skippable_cm(), util.edit_view(cr, 'website.aboutus', skip_if_not_noupdate=False) as arch:

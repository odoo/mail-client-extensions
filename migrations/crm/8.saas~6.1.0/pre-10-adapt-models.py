...
def migrate(cr, version):
    ...
    _move_categ(cr, 'crm.claim', 'crm.claim.category', {
        'crm_claim': 'categ_id',
    })
    _move_categ(cr, 'crm.helpdesk', 'crm.helpdesk.category', {
        'crm_helpdesk': 'categ_id',
    })

    # cleanup
    for t in ['crm_lead_tag', 'crm_phonecall_category',
              'crm_claim_category', 'crm_helpdesk_category']:

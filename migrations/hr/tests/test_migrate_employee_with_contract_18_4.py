...
class TestMigrateEmployeeWithContract(UpgradeCase):
    ...
    def check(self, init):
        ...
        self.assertEqual(contract_template.date_version, today)
        self.assertEqual(contract_template.contract_date_start, today)
        ...
        self.assertEqual(contract_template.trial_date_end, today + relativedelta(months=1))
        self.assertEqual(contract_template.contract_date_end, today + relativedelta(months=3))
        ...
        self.assertEqual(employee_version.date_version, today)
        ...
        self.assertEqual(employee_version.contract_date_start, today + relativedelta(days=2))
        ...
        self.assertEqual(employee_version.contract_date_end, today + relativedelta(months=3))
        ...
        self.assertEqual(employee_version.contract_date_start, today - relativedelta(months=2))
        self.assertEqual(employee_version.wage, 2000)
        self.assertEqual(employee_version.structure_type_id.id, structure_type_id)
        self.assertEqual(employee_version.department_id.id, department_id)
        self.assertEqual(employee_version.job_id, developer_job)
        self.assertFalse(employee_version.contract_type_id)
        self.assertEqual(employee_version.contract_date_end, today - relativedelta(days=1))
        self.assertEqual(employee_version.hr_responsible_id, self.env.user)
        ...
        self.assertEqual(employee_version.date_version, today)
        self.assertEqual(employee_version.contract_date_start, today)
        self.assertEqual(employee_version.wage, 3000)
        self.assertEqual(employee_version.structure_type_id.id, structure_type_id)
        self.assertEqual(employee_version.department_id.id, department_id)
        self.assertEqual(employee_version.job_id, team_leader_job)
        self.assertEqual(employee_version.resource_calendar_id, self.env.company.resource_calendar_id)
        self.assertEqual(employee_version.trial_date_end, today + relativedelta(months=1))
        self.assertFalse(employee_version.contract_date_end)

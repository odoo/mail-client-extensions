...
def migrate(cr, version):
    ...
    util.if_unchanged(cr, "helpdesk.solved_ticket_request_email_template", util.update_record_from_xml)
    util.if_unchanged(cr, "helpdesk.rating_ticket_request_email_template", util.update_record_from_xml)

    util.if_unchanged(cr, "helpdesk.digest_tip_helpdesk_0", util.update_record_from_xml)

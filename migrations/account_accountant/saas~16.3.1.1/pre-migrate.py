...
def migrate(cr, version):
    util.force_noupdate(cr, "account_accountant.digest_tip_account_accountant_0", noupdate=False)
    util.force_noupdate(cr, "account_accountant.digest_tip_account_accountant_1", noupdate=False)

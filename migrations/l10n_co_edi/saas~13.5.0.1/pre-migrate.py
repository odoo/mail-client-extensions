...
def migrate(cr, version):
    ...
    util.create_column(cr, 'uom_uom', 'l10n_co_edi_country_code', 'varchar')

    util.create_column(cr, 'res_country', 'l10n_co_edi_template_code', 'varchar')
    ...
    cr.execute('''UPDATE account_move am
                  SET debit_origin_id = am.l10n_co_edi_debit_origin_id
                  WHERE am.l10n_co_edi_debit_origin_id IS NOT NULL
    ''')

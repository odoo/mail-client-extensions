...
def migrate(cr, version):
    tags_to_migrate = (
        ...
        "tag_diot_16_tax",
        "tag_diot_16_non_cre_tax",
        "tag_diot_16_imp_tax",
        "tag_diot_16_imp_non_cre_tax",
        "tag_diot_8_tax",
        "tag_diot_8_non_cre_tax",
        "tag_diot_8_south_tax",
        "tag_diot_8_south_non_cre_tax",
        "tag_diot_16_imp_int_tax",
        "tag_diot_16_imp_int_non_cre_tax",
        "tag_diot_8_refund",

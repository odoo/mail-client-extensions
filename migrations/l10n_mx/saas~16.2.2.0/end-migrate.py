...
def migrate(cr, version):
    ...
    tags_to_migrate = [
        ...
        ("tag_diot_16_tax", "+DIOT: 16% TAX"),
        ("tag_diot_16_non_cre_tax", "+DIOT: 16% NO ACREDITABLE TAX"),
        ("tag_diot_16_imp_tax", "+DIOT: 16% IMP TAX"),
        ("tag_diot_16_imp_non_cre_tax", "+DIOT: 16% IMP NO ACREDITABLE TAX"),
        ("tag_diot_8_tax", "+DIOT: 8% N. TAX"),
        ("tag_diot_8_non_cre_tax", "+DIOT: 8% N. NO ACREDITABLE TAX"),
        ("tag_diot_8_south_tax", "+DIOT: 8% S. TAX"),
        ("tag_diot_8_south_non_cre_tax", "+DIOT: 8% S. NO ACREDITABLE TAX"),
        ("tag_diot_16_imp_int_tax", "+DIOT: 16% IMP INT TAX"),
        ("tag_diot_16_imp_int_non_cre_tax", "+DIOT: 16% IMP INT NO ACREDITABLE TAX"),

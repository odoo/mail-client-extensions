...
def migrate(cr, version):
    ...
    if util.table_exists(cr, "tax_accounts_v12_bckp"):
        ...
        for rep_type, tag_xmlids in (
            ("base", ("tag_diot_0", "tag_diot_16", "tag_diot_8")),
            ("tax", ("tag_diot_ret", "tag_iva", "tag_isr", "tag_ieps")),
        ):
            ...
            for tag_xmlid, tag_id in cr.fetchall():
                ...
                """,
                    {
                        "id": next_financial_line_id,
                        "xmlid": "MX_INJECTED_TAG_" + str(tag_id),
                        "name": "Tournicoti",
                        "domain": str([(domain_prefix, "in", (tag_id,))]),

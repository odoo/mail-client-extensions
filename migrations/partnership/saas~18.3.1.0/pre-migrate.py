...
def migrate(cr, version):
    ...
    if util.module_installed(cr, "website_crm_partner_assign"):
        ...
        util.move_field_to_module(
            cr, "res.partner.grade", "partner_weight", "partnership", "website_crm_partner_assign"
        )
        # move back fields from website.published.mixin
        util.move_field_to_module(
            cr, "res.partner.grade", "website_published", "partnership", "website_crm_partner_assign"
        )

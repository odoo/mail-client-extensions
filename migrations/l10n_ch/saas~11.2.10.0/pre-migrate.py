...
def migrate(cr, version):
    ...
    util.remove_record(cr, 'l10n_ch.tax_group_tva_38')
    util.remove_record(cr, 'l10n_ch.tax_group_tva_8')

    util.remove_record(cr, 'l10n_ch.vat_tag_301_a')
    util.remove_record(cr, 'l10n_ch.vat_tag_341_a')
    util.remove_record(cr, 'l10n_ch.vat_tag_301_b')
    util.remove_record(cr, 'l10n_ch.vat_tag_341_b')

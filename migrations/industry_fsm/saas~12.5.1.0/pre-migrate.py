...
def migrate(cr, version):
    ...
    util.remove_field(cr, "project.task", "partner_email")
    util.remove_field(cr, "project.task", "partner_phone")
    util.remove_field(cr, "project.task", "partner_mobile")
    util.remove_field(cr, "project.task", "partner_zip")
    util.remove_field(cr, "project.task", "partner_city")
    util.remove_field(cr, "project.task", "planned_date_begin")

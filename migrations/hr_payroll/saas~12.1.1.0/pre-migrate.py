...
def migrate(cr, version):
    ...
    util.remove_record(cr, "hr_payroll.hr_salary_rule_sales_commission")
    util.remove_record(cr, "hr_payroll.hr_payroll_rules_child_alw")
    util.remove_record(cr, "hr_payroll.hr_payroll_rules_baremeIII")
    util.remove_record(cr, "hr_payroll.hr_payroll_rules_baremeII")
    util.remove_record(cr, "hr_payroll.hr_payroll_rules_mis_ex_onss_2")
    util.remove_record(cr, "hr_payroll.hr_payroll_rules_mis_ex_onss_1")

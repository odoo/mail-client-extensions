...
def migrate(cr, version):
    ...
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_view_form_common"))
    util.rename_xmlid(cr, "coupon.sale_coupon_program_view_form", "coupon.coupon_program_view_coupon_program_form")
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_view_tree"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_view_search"))
    util.rename_xmlid(cr, *eb("coupon.view_{sale_,}coupon_program_kanban"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_action_coupon_program"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_view_promo_program_form"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_view_promo_program_tree"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_view_promo_program_search"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_program_action_promo_program"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_view_tree"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_action"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_view_form"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_generate_view_form"))
    util.rename_xmlid(cr, *eb("coupon.{sale_,}coupon_generate_action"))
    # qweb views

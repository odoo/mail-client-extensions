...
class TestSpreadsheetShareMigration(UpgradeCase):
    ...
    def check(self, init):
        ...
        expected_data_1 = json.dumps({"test": "data A"})
        ...
        self.assertEqual(base64.b64decode(document_1.datas), expected_data_1.encode())
        self.assertEqual(document_1.excel_export, b"UEsFBgAAAAAAAAAAAAAAAAAAAAAAAA==")
        self.assertEqual(document_1.spreadsheet_data, expected_data_1)
        ...
        expected_data_2 = json.dumps({"test": "data B"})
        ...
        self.assertEqual(base64.b64decode(document_2.datas), expected_data_2.encode())
        self.assertEqual(document_2.spreadsheet_data, expected_data_2)

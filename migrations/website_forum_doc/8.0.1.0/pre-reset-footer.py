...
def migrate(cr, version):
    ...
    # Theoretically it only adds a small "Documentation" link in the
    # footer, so customizations are unlikely.
    util.force_noupdate(cr, 'website_forum_doc.header_footer_custom', False)
